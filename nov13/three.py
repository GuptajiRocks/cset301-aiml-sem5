...
# --- Configuration Constants (Same as previous optimized runs) ---
MAX_WORDS = 10000
SEQUENCE_LENGTH = 100
EMBEDDING_DIM = 128
RNN_UNITS = 128 # Using 128 units for the SimpleRNN layer
EPOCHS = 15
BATCH_SIZE = 32
...
# ----------------------------------------------------------------------
# 2. Bidirectional SimpleRNN Model Implementation and Training
# ----------------------------------------------------------------------
print("\n" + "="*50)
print("2. Bidirectional SimpleRNN Model Implementation and Training")
print("="*50)
...
print("\nOptimized Bi-RNN Model Summary:")
optimized_model.summary()

# Train the model, applying class weights
print("\nStarting Optimized Bi-RNN Model Training (with Class Weights)...")
...
print("Optimized Bi-RNN Model Training Complete.")
...
# Plot Accuracy
plot_history(optimized_history, 'accuracy', 'Bi-RNN Model Accuracy')
plot_history(optimized_history, 'loss', 'Bi-RNN Model Loss')
